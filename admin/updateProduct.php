        ...
        <div id="main_content">
            ...
            <form id="addAdminForm" method="post" enctype="multipart/form-data" action="adminAction.php?act=updateProduct&&id=<?php echo $row['id'] ?>&&tab=productList">
                <ul class="addProduct">
                    ...
                    <li class="select_sorts">
                        ...
                        <select name="sortId">选择商品类型>
                            ...
                            foreach ($sort as $sorts) {
                                ...
                                ?>
                                <option value="<?php echo $sorts['id']; ?>" <?php echo $sorts['id'] == $row['sortId'] ? "selected='selected'" : null; ?>><?php echo $sorts['sortsname']; ?></option>
                                <?php
                            }
                    ...
                    <li>
                        <label>是否上架：</label>
                        <input type="radio" name="isPub" id="pubTrue" value="1" class="required" checked="checked">
                    ...
                    <li>
                        <label>商品描述：</label>
                        <textarea name="pDes" id="pDes" class="required"><?php echo $row['pDes'] ?></textarea>
                    </li>
                    <li>
                        <label>商品图片：</label>
                        <!--multiple支持多文件同时上传-->

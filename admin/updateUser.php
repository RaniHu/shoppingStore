...
<div class="wrapper">
    ...
    <div id="main">
        ...
        <div id="main_content">
            ...
            <form id="addAdminForm" method="post" enctype="multipart/form-data" action="adminAction.php?act=updateUser&&id=<?php echo $row['id'] ?>&&tab=userList">
                <ul class="addUser">
                    <input type="hidden" name="userId" value="<?php echo $row['id'] ?>"/>
                    <li>
                        <label>用户名：</label> <input type="text" name="username" class="required" value="<?php echo $row['username'] ?>">

                    </li>
                    <li>
                        <label>密码：</label><input type="password" name="pwd" class="required" value="<?php echo $row['pwd'] ?>">

                    </li>
                    <li>
                        <label>邮箱：</label> <input type="email" name="email" class="required" value="<?php echo $row['email'] ?>">
